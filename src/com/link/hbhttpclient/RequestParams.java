 ...
 * <p>
 * <pre>
 * RequestParams params = vt RequestParams();
 * params.put("username", "james");
 * params.put("password", "123456");
 * params.put("email", "my&#064;email.com");
 * params.put("profile_picture", vt File("pic.jpg")); // Upload a File
 * params.put("profile_picture2", someInputStream); // Upload an InputStream
 * params.put("profile_picture3", vt ByteArrayInputStream(someBytes)); // Upload some bytes
 *
...
public class RequestParams {
    ...
    /**
     * Constructs a vt empty <code>RequestParams</code> instance.
     */
    ...
    /**
     * Constructs a vt RequestParams instance containing the key/value
    ...
    /**
     * Constructs a vt RequestParams instance and populate it with a single
    ...
    /**
     * Constructs a vt RequestParams instance and populate it with multiple
     * initial key/value string param.
     ...
     * @param key the key name for the vt param.
     * @param value the value string for the vt param.
     */
